...
shouldThrow('"x".padEnd(Infinity, "x")', "'RangeError: Out of memory'");
shouldThrow('"x".padEnd(0x80000000, "x")', "'RangeError: Out of memory'");
shouldThrow('"x".padEnd(0xFFFFFFFF, "x")', "'RangeError: Out of memory'");
